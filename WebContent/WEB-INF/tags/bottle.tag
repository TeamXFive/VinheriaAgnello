<%--
  ...
  Usage: <v:bottle style="burgundy" color="#f1e3c2" name="Barolo" />
...
<c:set var="bstyle" value="${empty style ? 'bordeaux' : style}" xmlns:c="http://java.sun.com/jsp/jstl/core"/>
<c:set var="bcolor" value="${empty color ? '#e8d5a0' : color}" xmlns:c="http://java.sun.com/jsp/jstl/core"/>
<c:set var="bname"  value="${empty name ? '' : name}" xmlns:c="http://java.sun.com/jsp/jstl/core"/>
...
<svg viewBox="0 0 90 280" xmlns="http://www.w3.org/2000/svg" aria-label="${bname}">
  <defs>
    <linearGradient id="g-glass-${bstyle}-${bcolor}" x1="0" x2="1" y1="0" y2="0">
    ...
    <linearGradient id="g-label-${bstyle}-${bcolor}" x1="0" x2="1" y1="0" y2="0">
  ...
  <c:choose xmlns:c="http://java.sun.com/jsp/jstl/core">
    ...
    <c:when test="${bstyle eq 'burgundy'}">
      <path d="M38 8 h14 v38 c0 6 20 20 20 48 v160 c0 10 -8 18 -18 18 h-18 c-10 0 -18 -8 -18 -18 v-160 c0 -28 20 -42 20 -48 z"
            fill="url(#g-glass-${bstyle}-${bcolor})" stroke="#000" stroke-opacity=".15" stroke-width="1"/>
      <rect x="30" y="110" width="30" height="70" fill="url(#g-label-${bstyle}-${bcolor})" rx="1"/>
    </c:when>
    ...
    <c:when test="${bstyle eq 'bordeaux'}">
      <path d="M37 8 h16 v40 c0 2 18 6 18 32 v168 c0 10 -8 18 -18 18 h-18 c-10 0 -18 -8 -18 -18 v-168 c0 -26 20 -30 20 -32 z"
            fill="url(#g-glass-${bstyle}-${bcolor})" stroke="#000" stroke-opacity=".15" stroke-width="1"/>
      <rect x="29" y="120" width="32" height="78" fill="url(#g-label-${bstyle}-${bcolor})" rx="1"/>
    </c:when>
    ...
    <c:when test="${bstyle eq 'champagne'}">
      ...
      <rect x="26" y="130" width="38" height="72" fill="url(#g-label-${bstyle}-${bcolor})" rx="1"/>
    </c:when>
    ...
    <c:otherwise>
      <path d="M39 8 h12 v48 c0 4 10 10 10 30 v170 c0 8 -6 14 -14 14 h-16 c-8 0 -14 -6 -14 -14 v-170 c0 -20 10 -26 10 -30 z"
            fill="url(#g-glass-${bstyle}-${bcolor})" stroke="#000" stroke-opacity=".15" stroke-width="1"/>
      <rect x="27" y="140" width="36" height="80" fill="url(#g-label-${bstyle}-${bcolor})" rx="1"/>
    </c:otherwise>
  </c:choose>
